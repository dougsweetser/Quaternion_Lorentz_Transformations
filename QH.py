...
if __name__ == "__main__":
    ...
    class TestQH(unittest.TestCase):
        ...
        def test_1010_subs(self):
            q_z = self.q_sym.subs(self.sub_dict)
            print("t x y xyz sub 1 2 3 4: ", q_z)
            self.assertTrue(q_z.equals(QH([1, 2, 9, 24])))
        ...
        def test_1170_vahlen_conj_minus(self):
        ...
        def test_1180_vahlen_conj_star(self):
            q_z = self.Q.vahlen_conj("*")
            print("q_vahlen_conj *: ", q_z)
            self.assertTrue(q_z.t == 1)
            self.assertTrue(q_z.x == -2)
        ...
        def test_1190_vahlen_conj_prime(self):
            q_z = self.Q.vahlen_conj("'")
            print("q_vahlen_conj ': ", q_z)
            self.assertTrue(q_z.t == 1)
            self.assertTrue(q_z.x == 2)
        ...
        def test_1210_norm_squared(self):
        ...
        def test_1220_norm_squared_of_vector(self):
        ...
        def test_1250_abs_of_vector(self):
        ...
        def test_1290_product_even(self):
        ...
        def test_1300_product_odd(self):
        ...
        def test_1310_product_even_minus_odd(self):
        ...
        def test_1360_triple_product(self):
        ...
        def test_1490_q_sub(self):
            qs = self.q_sym.sub_q(self.sub_dict)
